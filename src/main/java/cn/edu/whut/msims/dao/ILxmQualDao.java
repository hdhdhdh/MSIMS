...
public interface ILxmQualDao {
    ...
    @Update("update tb_qual set qual_num=#{qual_num},qual_class=#{qual_class},qual_sdate=#{qual_sdate},qual_edate=#{qual_edate},qual_office=#{qual_office},qual_time=#{qual_time},admin_id=#{admin_id},qual_date=#{qual_date}")
    ...
    @Delete("delete form tb_qual where qual_num=#{qual_num}")
    public int deleteQualByNum(String qual_num);//根据证书编号删除证书
}
