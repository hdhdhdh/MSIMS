...
public interface EmeDirDao {
    ...
    @Update("update tb_drill set   dirll_num = #{ dirll_num}  where  dirll_name = #{ dirll_name} and  dirll_note = #{ dirll_note} and employ_num = #{employ_num} and admin_id = #{admin_id} and employ_num = #{employ_num} and dirll_date = #{dirll_date} and dirll_note = #{dirll_note} and dirll_path = #{dirll_path}")
