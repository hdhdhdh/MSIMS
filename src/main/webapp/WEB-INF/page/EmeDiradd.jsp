...
<div class ="section">
    ...
    <form method="post" action="${pageContext.request.contextPath}/dir/EmeDiradd.do">
        ...
        <input type="submit" value="添&nbsp;&nbsp;加" name="dirll_add" id="dirll_add"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="重&nbsp;&nbsp;置">
